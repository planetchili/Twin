...
// later on, will havec virtual sprite effect SpriteEffect::Drivers that instantiate the functors
...
{
public:
	virtual void Draw( const Vec2& pos,const RectI& clip,class Graphics& gfx,const SpriteEffect::Driver& effect,bool mirrored ) const = 0;
...
public:
	...
	{}
	void Draw( const Vec2& pos,const RectI& clip,class Graphics& gfx,const SpriteEffect::Driver& effect,bool mirrored ) const override;
	void Reset() override;
...
class SurfaceSpriteElement : public SpriteElement,private OffsetElement
{
public:
...
class AnimationSpriteElement : public SpriteElement,private OffsetElement
{
public:
